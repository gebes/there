...
func RequireHost(host string) func(request HttpRequest, next HttpResponse) HttpResponse {
...
func RequireHeader(key string, value string) func(request HttpRequest, next HttpResponse) HttpResponse {
	return func(request HttpRequest, next HttpResponse) HttpResponse {
